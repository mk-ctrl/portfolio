...
export const project = [
    ...
    {
        title: "HealthLink - An unified health index for reports and smartwatches",
        description: "HealthLink AI is an intelligent health companion that transforms fragmented medical records and real-time smartwatch data into a unified, visual health story. By utilizing Multimodal AI to digitize physical reports and a Multi-Output Random Forest model to predict chronic risks, it provides proactive care before emergencies arise.  The system organizes this information into an interactive Semantic Knowledge Graph, allowing patients to see the direct connections between their diagnoses, medications, and lifestyle.  It further integrates a Graph-RAG chatbot that provides personalized, evidence-based answers to user health queries based on their specific clinical history. Ultimately, HealthLink empowers patients with data autonomy, turning passive documents into actionable, life-saving insights through gamified engagement and intuitive design.",
        status: "Finished",
        // image: three
    },
    {
        title: "MindArmour - Browser Extension",
        description: "ManipuGuard is a browser extension that detects manipulative content like clickbait, emotional bait, and hype on websites and social media, then rewrites it in a calm, neutral tone to help users think clearly. It personalizes warnings based on user-selected interests (sports, finance, etc.) so only relevant flags appear during everyday browsing.In education mode, teachers create sessions with a URL and code, students join, analyze real sites manually in a focused view, explain manipulations in a chat, and receive AI-scored feedback on their reasoning and rewrites.Teachers get a dashboard with student scores, class trends, and chat logs to guide discussions and final evaluations, building real digital literacy skills.The project aims to protect users while teaching the next generation to recognize and counter digital manipulation in an increasingly AI-driven online world."
        , status: "Currently under development",
        // image: three
    }
...
export const contact = {
    phno: "8610332639",
    address: "Puthur,Officers Colony,Trichy",
...
export const achievements = [
    {
        title: "2nd Runner-Up — Hackathon by KPR",
        year: "2025",
    },
    {
        title: "2nd Runner-Up — Hackathon by KRCE",
        year: "2026",
    },
    {
    ...
    {
        title: "1st Place — Paper Presentation at JJ College, Bishop Heber College & St. Joseph's",
        year: "",
    },
    {
